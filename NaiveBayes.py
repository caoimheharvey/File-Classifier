...
val = [open('./text-files/hello.txt', 'r').read(), "good day"]
# 3 classes of training data
training_data = []
training_data.append({"class":"greeting", "sentence": val[1]})
training_data.append({"class":"greeting", "sentence":val[0]})
...
print()
classify("I want a taco", show_details=True)